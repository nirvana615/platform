    ...
    public class FlzWindowInfoController : ApiController
    {
        ...
        public string getWindowInfo()
        {
            ...
            if (cookieResult == COM.CookieHelper.CookieResult.SuccessCookkie)
            {
                ...
                List<Cartesian3> bps = JsonHelper.ToObject<List<Cartesian3>>(bpsList);
                List<Cartesian3> eyes = JsonHelper.ToObject<List<Cartesian3>>(eyesList);
                List<Cartesian3> sps = JsonHelper.ToObject<List<Cartesian3>>(spsList);
