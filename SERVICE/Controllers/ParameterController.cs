...
namespace SERVICE.Controllers
{
    ...
    public class ParameterController : ApiController
    {
        ...
        public string GetXMLB()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.ProjectCategory));
            foreach (var value in values)
            {
                string[] xmlb = (EnumExtension.GetRemark((MODEL.Enum.ProjectCategory)System.Enum.Parse(typeof(MODEL.Enum.ProjectCategory), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                xmlbs.Add(xmlb);
            }
        ...
        public string GetZHLX()
        {
            ...
            foreach (var value in values)
            {
                string[] zhlx = (EnumExtension.GetRemark((MODEL.Enum.GeodisasterType)System.Enum.Parse(typeof(MODEL.Enum.GeodisasterType), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                zhlxs.Add(zhlx);
            }
        ...
        public string GetZHDJ()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.GeodisasterLevel));
            foreach (var value in values)
            {
                string[] zhdj = (EnumExtension.GetRemark((MODEL.Enum.GeodisasterLevel)System.Enum.Parse(typeof(MODEL.Enum.GeodisasterLevel), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                zhdjs.Add(zhdj);
            }
        ...
        public string GetZHXQ()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.GeodisasterDanger));
            foreach (var value in values)
            {
                string[] zhxq = (EnumExtension.GetRemark((MODEL.Enum.GeodisasterDanger)System.Enum.Parse(typeof(MODEL.Enum.GeodisasterDanger), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                zhxqs.Add(zhxq);
            }
        ...
        public string GetJCJB()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.MonitorLevel));
            foreach (var value in values)
            {
                string[] jcjb = (EnumExtension.GetRemark((MODEL.Enum.MonitorLevel)System.Enum.Parse(typeof(MODEL.Enum.MonitorLevel), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                jcjbs.Add(jcjb);
            }
        ...
        public string GetJCSD()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.MonitorMeans));
            foreach (var value in values)
            {
                string[] jcsd = (EnumExtension.GetRemark((MODEL.Enum.MonitorMeans)System.Enum.Parse(typeof(MODEL.Enum.MonitorMeans), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                jcsds.Add(jcsd);
            }
        ...
        public string GetPMLX()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.SectionType));
            foreach (var value in values)
            {
                string[] pmlx = (EnumExtension.GetRemark((MODEL.Enum.SectionType)System.Enum.Parse(typeof(MODEL.Enum.SectionType), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                pmlxs.Add(pmlx);
            }
        ...
        public string GetPMDJ()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.SectionLevel));
            foreach (var value in values)
            {
                string[] pmdj = (EnumExtension.GetRemark((MODEL.Enum.SectionLevel)System.Enum.Parse(typeof(MODEL.Enum.SectionLevel), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                pmdjs.Add(pmdj);
            }
        ...
        public string GetJCFF()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.AutoDeviceType));
            foreach (var value in values)
            {
                string[] jcff = (EnumExtension.GetRemark((MODEL.Enum.AutoDeviceType)System.Enum.Parse(typeof(MODEL.Enum.AutoDeviceType), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                jcffs.Add(jcff);
            }
        ...
        public string GetJCZLX()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.GNSSStationType));
            foreach (var value in values)
            {
                string[] jczlx = (EnumExtension.GetRemark((MODEL.Enum.GNSSStationType)System.Enum.Parse(typeof(MODEL.Enum.GNSSStationType), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
                jczlxs.Add(jczlx);
            }
        ...
        public string GetAutoDataDateTime()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.AutoDataDateTime));
            foreach (var value in values)
            {
                string[] autodatadatetime = (EnumExtension.GetRemark((MODEL.Enum.AutoDataDateTime)System.Enum.Parse(typeof(MODEL.Enum.AutoDataDateTime), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
        ...
        public string GetDeviceType()
        {
            ...
            foreach (var value in values)
            {
                string[] devicetype = (EnumExtension.GetRemark((MODEL.Enum.AutoDeviceType)System.Enum.Parse(typeof(MODEL.Enum.AutoDeviceType), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
        ...
        public string GetPowerType()
        {
            ...
            System.Array values = System.Enum.GetValues(typeof(MODEL.Enum.PowerType));
            foreach (var value in values)
            {
                string[] powertype = (EnumExtension.GetRemark((MODEL.Enum.PowerType)System.Enum.Parse(typeof(MODEL.Enum.PowerType), ((int)value).ToString())) + ";" + (int)value).Split(new char[] { ';' });
