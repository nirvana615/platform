...
var baseMaps = new Array(
    ...
    new Cesium.ProviderViewModel({
        ...
        creationFunction: function () {
            ...
            //重庆天地图高清影像
            imageryProviders.push(new Cesium.ArcGisMapServerImageryProvider({
                url: 'http://zhsq.digitalcq.com:6080/arcgis/rest/services/IMG_MCT_2019/MapServer',
    ...
    new Cesium.ProviderViewModel({
        name: '重庆DEM',
        iconUrl: Cesium.buildModuleUrl('../../Resources/img/cesium/cqDEM.png'),
        creationFunction: function () {
            var imageryProviders = [];
            //天地图影像（底图）
            imageryProviders.push(new Cesium.WebMapTileServiceImageryProvider({
            ...
            //重庆DEM
            imageryProviders.push(new Cesium.ArcGisMapServerImageryProvider({
                url: 'http://zhsq.digitalcq.com:6080/arcgis/rest/services/DEM/MapServer',
                enablePickFeatures: false
            }));
            ////天地图影像中文标注
            //imageryProviders.push(new Cesium.WebMapTileServiceImageryProvider({
    ...
    new Cesium.ProviderViewModel({
        ...
        creationFunction: function () {
            ...
            //重庆天地图最新影像
            imageryProviders.push(new Cesium.ArcGisMapServerImageryProvider({
                url: 'http://zhsq.digitalcq.com:6080/arcgis/rest/services/IMG_MCT/MapServer',
                enablePickFeatures: false
            }));
            //天地图影像中文标注
            imageryProviders.push(new Cesium.WebMapTileServiceImageryProvider({
 ...
 * 修改样式
 */
document.getElementsByClassName("cesium-viewer-toolbar")[0].style = "right:130px;top:30px;width:120px;height:60px ";  
