...
function jieLiTongji() {
    ...
    cequ = layer.open({
        ...
        , moveOut: true
        ,content:jieliTable
       // , content: '<!--创建项目--><form class="layui-form" style="margin-top:5px;margin-right:5px;" lay-filter="queryJieliinfoform"><div class="layui-form-item"><div class="layui-row"><div class="layui-col-md4"><div class="grid-demo grid-demo-bg1"><label class="layui-form-label">节理名称</label><div class="layui-input-block"><input type="text" name="name" autocomplete="off" placeholder="请输入"  class="layui-input" /></div></div></div><div class="layui-col-md4"><div class="grid-demo"><label class="layui-form-label">测窗</label><div class="layui-input-block"><select id="windowIdSelect" name="windowId"><option value="">请选择</option></select></div></div></div><div class="layui-col-md4"><div class="grid-demo grid-demo-bg1"><label class="layui-form-label">模型</label><div class="layui-input-block"><select id="modleIdSelect" name="modleId"><option value="">请选择</option></select></div></div></div></div></div><div class="layui-form-item" style="margin-top:5px;height: 40px"><div style="position:absolute;right:15px;"><button type="reset" class="layui-btn layui-btn-primary" style="width:100px">重置</button><button type="submit" class="layui-btn" lay-submit="" lay-filter="queryJielisubmit" style="width:100px">查询</button></div></div></form><table class="layui-hide" id="jielitable-view" lay-filter="jielitable-view"></table>'
        , zIndex: layer.zIndex
        , success: function (layero) {
            layer.setTop(layero);
            if (windowInfoList.length > 0) {
